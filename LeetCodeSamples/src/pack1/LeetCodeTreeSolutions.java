...
public class LeetCodeTreeSolutions {
	...
	//Bu fonksiyonda hata var m�?(06.02.2026) . (Do�ru gibi. 13.02.2026)
	...
	{	
		...
		//Bu fonksiyonda hata var m�?(06.02.2026)
		int size = arr.length;
	...
	{ 
		//Karma��kl���n O(n)'den k���k olmas� isteniyor.
		//Yap�lamad�(23.01.2026)
		int count = 0;
		int level=0;
		Queue<TreeNode> q = new LinkedList<>();
		TreeNode curr=null, left=null, right=null;
	...
	public static List<Integer> treeToList(TreeNode root)
	{
		...
		/*
		  ...
		  Olu�an hata : java.lang.OutOfMemoryError: Java heap space
		  while d�ng�s�n�n 25.iterasyonunda  
		  		q1.size=33.554.432, list1.size=67.108.863, set.size=2   oluyor.
		  
		  Kullan�lan parametre: 
		  Integer [][] arr = {
		...
		*/
		...
		//System.out.println("treeToList fonksiyonu i�erisinde");
		int j=0;
		...
		while(!q1.isEmpty() && result==true) 
		{
			...
			System.out.println("treeToList fonksiyonu i�erisinde j=" + j + ", q1.size="+size + ", list1.size=" + list1.size() + ", set.size=" + set.size());
	...
	public static boolean isSubtree(TreeNode root, TreeNode subRoot) 
	{
		...
		System.out.println("TreeToList �ncesi");
		...
		System.out.println("while d�ng�s�ne ba�lanacak!");
	...
	public static TreeNode lcaDeepestLeaves(TreeNode root) 
	{
		...
		Problem A��klama  : Given the root of a binary tree, return the lowest common ancestor of its deepest leaves.
		Link              : https://leetcode.com/problems/lowest-common-ancestor-of-deepest-leaves/?envType=problem-list-v2&envId=binary-tree
		��z�m Algoritmas� : BFS ile deepest node'lar ve her bir node'a ait parent node belirlenir.
		                    Deepest node'lar ortak parent bulunmaya �al���l�r. 
		*/
	...
	public static TreeNode removeLeafNodes(TreeNode root, int target) 
	{
		/*
			...
			Problem A��klama  : Given a binary tree root and an integer target, delete all the leaf nodes with value target.
			Link              : https://leetcode.com/problems/delete-leaves-with-a-given-value/description/?envType=problem-list-v2&envId=binary-tree
			��z�m Algoritmas� : BFS ile a�a� �zerinde seviye bazl� ilerlenir. o anki node bir leaf node ise ve de�eri de uyumlu ise parent node'un ilgili child nodu null yap�l�r.
			                    Deepest node'lar ortak parent bulunmaya �al���l�r. 
			Durum             : ��z�ld�.
		*/
    ...
    public static int goodNodes(TreeNode root) 
    {
		...
		Problem A��klama  : Given a binary tree root, a node X in the tree is named good if in the path from root to X there are no nodes with a value greater than X.
    ...
    public static List<List<Integer>> levelOrder(TreeNode root) 
    {
		...
		Problem A��klama  : Given the root of a binary tree, return the level order traversal of its nodes' values. (i.e., from left to right, level by level).						    
		Link              : https://leetcode.com/problems/binary-tree-level-order-traversal/?envType=problem-list-v2&envId=binary-tree
		��z�m Algoritmas� : Kuyruk veri yap�s� kullan�larak seviye bazl� dola�ma(BFS) yap�l�r.
		Durum             : ��z�ld�.
	    */
    ...
    {    	
		...
		Problem A��klama  : Given the root of a binary tree, return the leftmost value in the last row of the tree.						    
    ...
    public static List<Integer> rightSideView(TreeNode root) 
    {
		...
		Problem A��klama  : Given the root of a binary tree, imagine yourself standing on the right side of it, return the values of the nodes you can see ordered from top to bottom.						    
		Link              : https://leetcode.com/problems/binary-tree-right-side-view/description/?envType=problem-list-v2&envId=binary-tree
		��z�m Algoritmas� : Kuyruk veri yap�s� kullan�larak seviye bazl� dola�ma(BFS) yap�l�r. Her seviye i�in kuyru�un en son eleman� al�n�r.
		Durum             : ��z�ld�.
	    */
	...
	public static TreeNode2 connect(TreeNode2 root) 
	{
		/*
			...
			Ancak bu problem bir Tree sorusu oldu�u i�in bu �ekilde g�ncellendi.
		*/
	...
	public static int widthOfBinaryTree(TreeNode root) 
	{
		//�al��m�yor
		//13.02.2026
		//kuyruk'un boyutu s�rekli art�yor.
	...
	public static void testCases() 
	{
		...
		*/
		...
		/*
		Integer [][] arr = {{10,5,15,3,7,null,18}};    //seviye seviye, �nce 1.seviyedeki node'lar sonra 2.seviyedekiler ...		
		TreeNode root = arrayToTree(arr[0]);		
		...
		*/
		...
		Integer [][] arr = {{3,5,1,6,2,0,8,null,null,7,4,null,null,null,null},{1},{0,1,3,null,2},{3,5,1,6,2,0,8,null,null,7,4,null,9,10,null},{1}};    //seviye seviye, �nce 1.seviyedeki node'lar sonra 2.seviyediler ...		
		TreeNode root = arrayToTree(arr[2]);		
	...
	public static void main(String [] args) 
	{
		...
		Integer [][] arr = {{3,1,3,null,null,0,1},              
						   ...
						   };    //seviye seviye, �nce 1.seviyedeki node'lar sonra 2.seviyedekiler ...
