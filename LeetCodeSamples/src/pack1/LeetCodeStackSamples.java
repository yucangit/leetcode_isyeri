...
public class LeetCodeStackSamples {
    ...
    public static int calculate2(String s) 
    {
    	/*
		  ...
		  Algoritma     : 
		  Diger         : unary operator kismi henuz dusunulmedi. Cikarma islemini tersten yapmak yanlis sonuc uretilmesine neden oluyor.
		  				  Ornekler(Yanlis sonuc uretilen) : 
		  					"-(1 - 2) - 3",                        //-2
		  				    "-(((-(1 - 2) - 3 ) + 6) - 7 + 8)",    //-5 
		...
		*/
    	...
    	//Step1.2: tokenization2 - Unary operator processing
    	for(int i=0; i<list.size(); i++) 
    	{
    		String token = list.get(i);
    		if( token.equals("-")  && (i==0 || list.get(i-1).equals("(" ) ) )    //unary operator
    		{
    	...
    	//artik stack hic parantez icermiyor.
    ...
    public static String countOfAtoms(String formula) 
    {
    	/*
		  Tarih         : 21.04.2026
		  Durum         : Yapiliyor  
		  Problem Adi   : Number of Atoms
		  Problem Link  : https://leetcode.com/problems/number-of-atoms/description/?envType=problem-list-v2&envId=stack
		  Algoritma     : 
		  Diger         : 
		*/
